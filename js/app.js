...
document.getElementById("pWhoHer").textContent = CONFIG.friendName;
...
function setPostSender(who) {
  ...
  document.getElementById("pWhoHer").classList.toggle("is-active", who === "W");
  document.getElementById("pWhoMe").classList.toggle("is-active", who === "M");
}
